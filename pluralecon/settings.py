"""
Django settings for pluralecon project.
...
WSGI_APPLICATION = 'pluralecon.wsgi.application'
...
# Media files (user uploads, audio files, etc.)
MEDIA_URL = 'media/'
...
OPENAI_API_KEY = os.environ.get('OPENAI_API_KEY', '')  # For TTS audio generation
